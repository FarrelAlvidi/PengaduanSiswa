<x-app-layout>
    <div class="relative flex flex-col  mx-auto mt-20 max-w-7xl h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
          ...
          <table class="w-full mt-4 text-left table-auto min-w-max">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="p-4 border-b border-blue-gray-50">
                      <p class="text-center block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
